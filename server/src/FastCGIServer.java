        ...
        while (fcgiInterface.FCGIaccept() >= 0) {
            ...
            try {
                ...
                if (queryString == null || queryString.isEmpty()) {
                    String historyResponse = JsonUtils.buildResponseJson("null", history);
                    HttpResponse.sendJson(historyResponse);
                    continue;
                }
                ...
                if (xStr == null || yStr == null || rStr == null) {
                    String historyOnlyJson = JsonUtils.buildResponseJson("null", history);
                    HttpResponse.sendJson(historyOnlyJson);
                    continue;
                }
